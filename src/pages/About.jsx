      ...
      <div>
        <div className="border-b border-dashed border-gray-300 pb-4">
          ...
          <p className="mt-2 text-gray-600">
            ...
            mindset, and my energy. That shift led me to clean eating, fitness,
            and falling in love with the gym. What started as a decision became
        ...
        <div className="mt-8 flex gap-4 justify-center flex-wrap pb-8">
          <img
            src="https://i.ibb.co/YBMKY2fD/APRIL-2024.jpg"
            className="h-80 w-50 rounded-2xl object-cover"
          />
          <img
            src="https://i.ibb.co/W44ZWJC2/SS.jpg"
            className="h-80 w-50 rounded-2xl object-cover"
          />
          <img
            className="h-80 w-50 rounded-2xl object-cover"
            src="https://i.ibb.co/qLKZgGTy/IMG-2908.jpg"
          />
          <img
            className="h-80 w-50 rounded-2xl object-cover"
            src="https://i.ibb.co/pBVkV59g/IMG-7457-Copy.jpg"
          />
          <img
            className="h-80 w-50 rounded-2xl object-cover"
            src="https://i.ibb.co/9kXV2r0J/VEE02883.jpg"
          />
          <img
            className="h-80 w-50 rounded-2xl object-cover"
            src="https://i.ibb.co/ynNB95L4/VDP09556.jpg"
          />
        </div>
      </div>
    </div>
